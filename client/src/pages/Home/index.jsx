            ...
            return (
                <div key={index} className={cx("timeshare-box")}>
                    ...
                    <div className={cx("content")}>
                        ...
                        {/* Desc */}
                        <p className={cx("desc")}>
                            Lorem ipsum dolor sit amet, wisi nemore fastidii at
                            vis, eos equidem admodum
                        </p>
                        {/* Price */}
