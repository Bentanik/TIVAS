...
import styles from "./AdminCreateTimeshare.module.scss";
            ...
            <form onSubmit={handleSubmit}>
                <div className={cx("form")}>
                    ...
                    <div className={cx("input_compo")}>
                        <label htmlFor="name_timeshare" className={cx("label")}>
                            Timeshare name
                        </label>
                        <input
                            type="text"
                            id="name_timeshare"
                            className={cx("input")}
                            placeholder="Enter timeshare name"
                        />
                    </div>
                    <div className={cx("input_compo")}>
...
export default AdminCreateTimeshare;
